...
class NewsManagerUserDetailsService(
    ...
    override fun loadUserByUsername(username: String?): UserDetails? {
        ...
        return user?.let { NewsManagerUserDetails(user) }
    }
}

data class NewsManagerUserDetails(val id: Long, val user: String, val pass: String, val roleType: RoleType) : UserDetails {
    constructor(user: User) : this(user.id, user.username, user.password, user.roleType)
